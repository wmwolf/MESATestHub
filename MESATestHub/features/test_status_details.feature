Feature: View Test Status Details
  Background: three tests and several test instances are created
    ...
    And the following test instances have been created:
      | runtime_seconds | mesa_version | passed | test_case        | computer      |
  ...
  Scenario: Passing test should show as passing
    Given I am on the test detail page for "1M_pre_ms_to_wd"
    Then I should see "Last version tested: 10000"
    And I should see "Last version status: Passing"
    And I should see "Last test status: Passing"

  Scenario: Failing test should show as failing
    Given I am on the test detail page for "15M_thermohaline"
    Then I should see "Last version tested: 10000"
    And I should see "Last version status: Failing"
    And I should see "Last test status: Failing"
